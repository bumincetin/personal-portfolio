...
export const translations: Record<Locale, TranslationType> = {
  ...
  tr: {
    ...
    hero: {
      ...
      subtitle: 'Veri Bilimci & AI Uzmanı',
      cta: 'Araştırmayı Gör',
    },
    ticker: {
      python: 'PYTHON',
    ...
    methodologyPage: {
      ...
      servicesLabel: 'Temel Hizmet Alanları',
      section1: {
        num: '01.',
        title: 'Finansal Analitik & Modelleme',
        arch: 'Tahminsel Modeller • Risk Niceleme • Portföy Optimizasyonu',
      ...
      section2: {
        ...
        arch: 'Transformer Modelleri • Duygu Analizi • Belge Zekası',
      ...
      section3: {
        ...
        arch: 'PowerBI • Özel Python • Gerçek Zamanlı Analitik',
      ...
      section4: {
        ...
        arch: 'Sınır Ötesi Danışmanlık • Mevzuat Uyumu • Stratejik Planlama',
