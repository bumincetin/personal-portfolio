...
export default function WhySMEPageClient({ locale }: WhySMEPageClientProps) {
  ...
  return (
    <div className="pt-24 md:pt-32 pb-16 bg-cream min-h-screen">
      ...
      {/* Hero Section */}
      <section className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16 mb-16">
        <motion.div
        ...
        >
          ...
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-charcoal mb-6 max-w-4xl mx-auto leading-tight">
            {sme.pageTitle}
          </h1>
          ...
          <p className="font-mono text-base md:text-lg text-muted max-w-3xl mx-auto leading-relaxed">
            {sme.intro}
          </p>
        </motion.div>
      </section>
        ...
        <div className="space-y-12 md:space-y-16">
          {sme.benefits.map((benefit, idx) => (
            <motion.div
              ...
              className="bg-white border border-border p-8 md:p-12 hover:shadow-editorial transition-all duration-300"
            >
                  ...
                  {benefit.examples && benefit.examples.length > 0 && (
                    <div className="border-t border-border pt-6">
                      <button
                        ...
                        className="flex items-center gap-2 font-mono text-xs uppercase tracking-wider text-accent hover:text-charcoal transition-colors w-full justify-between mb-4"
                      >
                        <span>
                      ...
                      >
                        <div className="space-y-4">
                          {benefit.examples.map((example, i) => (
                            <div key={i} className="bg-white border-l-4 border-accent pl-4 py-2">
        ...
        >
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-7">
              ...
              <p className="font-mono text-base text-cream/80 leading-relaxed mb-6">
                {sme.hybridDesc}
              </p>
              
              <p className="font-mono text-sm md:text-base text-cream/70 leading-relaxed">
                {sme.hybridDetails}
              </p>
            </div>
            ...
            <div className="lg:col-span-5">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/5 backdrop-blur-sm p-6 text-center border border-white/10">
                  <Building2 className="mx-auto mb-3 text-accent" size={32} />
                  <div className="font-serif text-2xl text-accent mb-2">+</div>
                ...
                <div className="bg-white/5 backdrop-blur-sm p-6 text-center border border-white/10">
                  <LineChart className="mx-auto mb-3 text-accent" size={32} />
                  <div className="font-serif text-2xl text-accent mb-2">+</div>
                  <div className="font-mono text-xs text-cream/70 uppercase tracking-wider">
                    {locale === 'tr' ? 'Finans' : locale === 'it' ? 'Finanza' : 'Finance'}
                  </div>
                </div>
                <div className="col-span-2 bg-accent/20 backdrop-blur-sm p-6 text-center border border-accent/30">
                  <Target className="mx-auto mb-3 text-cream" size={32} />
                  <div className="font-serif text-xl text-cream mb-2">=</div>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 lg:px-16">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="text-center bg-white border border-border p-8 md:p-12"
        >
          <p className="font-mono text-base md:text-lg text-charcoal mb-8 max-w-2xl mx-auto leading-relaxed">
            {sme.cta}
          </p>
          <button
