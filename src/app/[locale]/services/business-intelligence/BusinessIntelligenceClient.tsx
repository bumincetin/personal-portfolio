...
import { ArrowLeft, BarChart3, PieChart, Activity, Database, CheckCircle2 as CheckCircle } from 'lucide-react';
            ...
            <div className="space-y-6">
              ...
              <div className="bg-surface-raised border border-accent/25 p-6 rounded-editorial text-charcoal">
                ...
                <div className="space-y-3 font-sans text-sm">
                  ...
                  <div className="flex justify-between border-b border-cream/20 pb-2">
                    <span className="text-muted">ETL</span>
              ...
              <div className="bg-surface border border-border p-6 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {['KPI Tracking', 'Real-time Data', 'Drill-down', 'Export PDF'].map((feature, idx) => (
                    <div key={idx} className="flex items-center gap-2 p-2 bg-surface-alt rounded text-sm font-sans text-muted">
