  ...
  return (
    <div className="pt-32 pb-20">
      <section className="container mx-auto px-6 mb-16 text-center">
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-accent-cyan font-mono mb-4 tracking-widest text-sm">
          {t.assetsPage.label}
        </motion.p>
            ...
            <motion.div key={idx} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: idx * 0.1 }}>
              <GlassCard className="p-8 h-full flex flex-col">
                <div className="flex items-start justify-between mb-6">
                  ...
                  {project.stars > 0 && (
                    <div className="flex items-center gap-1 text-text-muted text-sm font-mono">⭐ {project.stars}</div>
                  )}
                </div>
      ...
      <section className="container mx-auto px-6 mt-20 text-center">
        <GlassCard className="p-12">
          <h3 className="font-serif text-3xl mb-4">{t.assetsPage.moreGithub}</h3>
          <p className="text-text-muted mb-8 max-w-xl mx-auto">{t.assetsPage.moreGithubDesc}</p>
