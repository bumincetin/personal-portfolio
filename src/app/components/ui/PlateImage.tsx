...
/**
 * Studio photography on an obsidian page.
 *
 ...
 * ground and given a faint champagne wash so it sits in the page instead of on
 * top of it.
 */
export default function PlateImage({
  ...
  return (
    <div className={`relative overflow-hidden rounded-editorial ${className}`}>
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(115%_95%_at_50%_12%,transparent_28%,rgba(8,7,12,0.92)_100%)]" />
      {/* Champagne wash, so the remaining highlights read warm rather than raw. */}
