            ...
            <div className="grid grid-cols-1 md:grid-cols-2 h-full">
              ...
              <div className="bg-surface-alt p-8 flex items-center justify-center order-1 md:order-2 relative overflow-hidden">
                ...
                <motion.div
                  ...
                  animate={{
                    background: [
                      'radial-gradient(circle at 20% 50%, rgb(var(--c-brass) / 0.1) 0%, transparent 50%)',
                      'radial-gradient(circle at 80% 50%, rgb(var(--c-brass) / 0.1) 0%, transparent 50%)',
                      'radial-gradient(circle at 20% 50%, rgb(var(--c-brass) / 0.1) 0%, transparent 50%)',
                    ],
                  }}
                ...
                <div className="grid grid-cols-2 gap-4 font-mono text-xs text-muted relative">
                  {[
                    ...
                    <motion.div 
                      ...
                      whileHover={{ scale: 1.05, borderColor: 'rgb(var(--c-brass))' }}
